...
def create_nwis_sf_df(control_file_name, model_dir, output_netcdf_filename, hru_gdf, poi_df, nwis_gage_nobs_min): # add neis_gage_nobs_min, hru_gdf, 
    ...
    if output_netcdf_filename.exists():
        ...
        con.print(f"All available streamflow observations for gages in the gages file were previously retrieved from NWIS database and included in the sf_efc.nc file. [bold]To update NWIS data, delete sf_efc.nc and nwis_cache.nc and rerun 1_Create_Streamflow_Observations.ipynb.[/bold]")       
    else:
